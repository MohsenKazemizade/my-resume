  ...
  return (
    ...
    >
      ...
      <p className="text-gray-200 text-left mb-4">
        ...
        Hi I am Mohsen Kazemizade a Web Developer. Dedicated React Developer
        with expertise in crafting responsive web applications using NextJs,
        React and Tailwind css. Proven ability to enhance user interfaces and
        experiences, focusing on performance and scalable solutions. Committed
        to innovative web development.
      </p>
