  ...
  return (
    <div className="absolute top-0 left-0 h-full w-full bg-gradient-to-r from-slate-700 to-slate-950 rotate-y-180 -translate-z-px py-6 px-8">
      ...
      <span
        ...
        className="absolute fill-arrow hover:fill-arrowhover duration-300 w-6 h-6 bottom-4 left-6 cursor-pointer justify-center items-center inline-flex nextprev-btn"
        data-page="turn-1"
      >
